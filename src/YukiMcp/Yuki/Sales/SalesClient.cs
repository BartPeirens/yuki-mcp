...
namespace YukiMcp.Yuki.Sales
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.theyukicompany.com/", ConfigurationName="YukiMcp.Yuki.Sales.SalesSoap")]
    public interface SalesSoap
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.theyukicompany.com/ProcessSalesInvoices", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<System.Xml.XmlNode> ProcessSalesInvoicesAsync(string sessionId, string administrationId, System.Xml.XmlNode xmlDoc);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.theyukicompany.com/ProcessRecognizedSalesInvoices", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<System.Xml.XmlNode> ProcessRecognizedSalesInvoicesAsync(string sessionId, string administrationId, System.Xml.XmlNode xmlDoc);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.theyukicompany.com/SalesInvoiceSchemaPath", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<string> SalesInvoiceSchemaPathAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.theyukicompany.com/GetSalesItems", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<YukiMcp.Yuki.Sales.SalesItem[]> GetSalesItemsAsync(string sessionID, string administrationID);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public interface SalesSoapChannel : YukiMcp.Yuki.Sales.SalesSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public partial class SalesSoapClient : System.ServiceModel.ClientBase<YukiMcp.Yuki.Sales.SalesSoap>, YukiMcp.Yuki.Sales.SalesSoap
    {
        ...
        public SalesSoapClient(EndpointConfiguration endpointConfiguration) : 
                base(SalesSoapClient.GetBindingForEndpoint(endpointConfiguration), SalesSoapClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public SalesSoapClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(SalesSoapClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public SalesSoapClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(SalesSoapClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        public System.Threading.Tasks.Task<System.Xml.XmlNode> ProcessSalesInvoicesAsync(string sessionId, string administrationId, System.Xml.XmlNode xmlDoc)
        {
            return base.Channel.ProcessSalesInvoicesAsync(sessionId, administrationId, xmlDoc);
        }
        
        public System.Threading.Tasks.Task<System.Xml.XmlNode> ProcessRecognizedSalesInvoicesAsync(string sessionId, string administrationId, System.Xml.XmlNode xmlDoc)
        {
            return base.Channel.ProcessRecognizedSalesInvoicesAsync(sessionId, administrationId, xmlDoc);
        }
        
        public System.Threading.Tasks.Task<string> SalesInvoiceSchemaPathAsync()
        {
            return base.Channel.SalesInvoiceSchemaPathAsync();
        }
        
        public System.Threading.Tasks.Task<YukiMcp.Yuki.Sales.SalesItem[]> GetSalesItemsAsync(string sessionID, string administrationID)
        {
            return base.Channel.GetSalesItemsAsync(sessionID, administrationID);
        }
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.SalesSoap))
            {
            ...
            if ((endpointConfiguration == EndpointConfiguration.SalesSoap12))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.SalesSoap))
            {
                return new System.ServiceModel.EndpointAddress("https://api.yukiworks.be/ws/Sales.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.SalesSoap12))
            {
                return new System.ServiceModel.EndpointAddress("https://api.yukiworks.be/ws/Sales.asmx");
